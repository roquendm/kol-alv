...
public class CloseableTabbedPane extends JTabbedPane implements MouseListener, MouseMotionListener {
   ...
   *
   */
  private static final long serialVersionUID = 8977765501508597208L;
   ...
   */
  Icon normalCloseIcon = null;

  /**
   * The closeicon when the mouse is over.
   */
  Icon hooverCloseIcon = null;

  /**
   * The closeicon when the mouse is pressed.
   */
  Icon pressedCloseIcon = null;
